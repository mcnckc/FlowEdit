...
if __name__ == "__main__":   
    ...
    pipe.transformer.transformer_blocks[10].attn.set_processor(PatchedJointAttnProcessor2_0(mode='caching', patching_step=30))
    ...
    pipe.transformer.transformer_blocks[10].attn.processor.patching_step = 30
    tar_im = pipe(
        prompt=src_prompt,
        negative_prompt="",
        num_inference_steps=50,
    ...
    tar_im.save(f"{cur_path}/tar-cfg{cur_cfg}-nmax{30}.png")
